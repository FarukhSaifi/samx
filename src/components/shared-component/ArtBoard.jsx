            ...
            <div className="col-12 text-center social-style-4">
              ...
              <div className="social-icon-style-3">
                <ul className="margin-30px-top medium-icon">
                  <li>
                    <Link className="facebook" to="http://facebook.com" target="_blank">
                      <i className="fab fa-facebook-f"></i>
                      <span></span>
                    </Link>
                  </li>
                  <li>
                    <Link className="twitter" to="http://twitter.com" target="_blank">
                      <i className="fab fa-twitter"></i>
                      <span></span>
                    </Link>
                  </li>
                  <li>
                    <Link className="google" to="http://google.com" target="_blank">
                      <i className="fab fa-google-plus-g"></i>
                      <span></span>
                    </Link>
                  </li>
                  <li>
                    <Link className="dribbble" to="http://dribbble.com" target="_blank">
                      <i className="fab fa-dribbble"></i>
                      <span></span>
                    </Link>
                  </li>
                  <li>
                    <Link className="linkedin" to="http://linkedin.com" target="_blank">
