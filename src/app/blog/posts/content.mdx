...
Social links are rendered on the `/about` page and in the footer based on the array configured in the `social` object. You can set custom icons to each, but don't forget to import them in `src/samx/icons.ts`. Read the SamX documentation](https://samx.vercel.com/docs/icons) for more information.
...
`const social = [
    {
      name: "GitHub",
      icon: "github",
      link: "https://github.com/samx/nextjs-starter",
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:contact@samx.vercel.com",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
