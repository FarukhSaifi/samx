...
summary: "Magic Portfolio is a comprehensive, MDX-based, SEO-friendly, responsive portfolio template built with SamX and Next.js."
...
Magic Portfolio is a comprehensive, MDX-based, SEO-friendly, responsive portfolio template built with SamX and Next.js.
...
Subscribe to the [SamX Pro plan](https://samx.vercel.com/pricing) to extend the license to [Dopler CC](https://samx.vercel.com/products/magic-portfolio).
...
<CodeBlock compact marginBottom="16" codes={[
  {
    code: "git clone https://github.com/samx/magic-portfolio.git",
    language: "bash"
  }
]} />
