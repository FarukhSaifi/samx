  ...
  featured: {
    ...
    title: (
      <Row gap="12" vertical="center">
        <strong className="ml-4">{person.name}</strong> <Line background="brand-alpha-strong" vert height="20" />
        <Text marginRight="4" onBackground="brand-medium">
          Featured work
        </Text>
      </Row>
    ),
    href: `${ROUTES.WORK}/building-samx-a-customizable-design-system`,
  },
  subline: (
    <>
